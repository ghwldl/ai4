...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
    ...
    labels[1] : {"texts"  : ["자장면은 맛있어"],"images" : ["https://minio.nculture.org/amsweb-opt/multimedia_assets/5/13787/20519/c/13787-medium-size.jpg"]},
    labels[2] : {"texts"  : ["짬뽕은 맛있어"],"images" : ["https://onlmenu.com/data/file/sb/3667802933_mzNcx5nk_365bb2940ef6e7a5212b2e39645860cb0c271ddb.JPG"]},
    labels[3] : {"texts"  : ["탕수육은 맛있어"],"images" : ["https://img.siksinhot.com/article/1711422146045324.jpeg"]},
}
